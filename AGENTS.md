...
plugins-full.json   full flavor 的预置清单：packages（任务看板/Git 图谱/右侧面板/SSH
                    ...
                    运行时 preset-plugins.json（{seed, carry}），main.js 启动时按
                    seed 组做一次性 profile 播种
